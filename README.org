...
If you like flying in first-person from the in-vehicle cockpit, either in stock or using
[[https://forum.kerbalspaceprogram.com/index.php?/topic/190737-18x-112x-rasterpropmonitor-adopted/][RPM]] and/or [[https://forum.kerbalspaceprogram.com/index.php?/topic/160856-wip-111x-moardvs-avionics-systems-mas-interactive-iva-v123-21-may-2021/][MAS,]] then this mod is for you.
...
You can provide multiple IVAs for your command modules: this might allow for an empty (low
...
IVA, plus a "Select IVA" button that shows a drop down menu. When in-flight, only the "Select IVA" button is available.
