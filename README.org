...
| Name               | CFG Name            | From  | IVA             | Support Status |
|--------------------+---------------------+-------+-----------------+----------------|
| Mk1 Cockpit        | Mark1Cockpit        | Stock | Stock           | Done           |
|                    |                     |       | RPM             | Done           |
|                    |                     |       | DE_IVAExtension | Done           |
|                    |                     |       | ASET            | Done           |
|--------------------+---------------------+-------+-----------------+----------------|
| Mk1 Command Pod    | mk1pod_v2           | Stock | Stock           | Done           |
|                    |                     |       | RPM             | Done           |
|                    |                     |       | DE_IVAExtension | Done           |
|                    |                     |       | Warbirds        | Done           |
|--------------------+---------------------+-------+-----------------+----------------|
| Mk1 Inline Cockpit | Mark2Cockpit        | Stock | Stock           | Done           |
|                    |                     |       | DE_IVAExtension | Done           |
|                    |                     |       | Warbirds        | Done           |
|                    |                     |       | WarbirdsSI      | Bugs           |
|--------------------+---------------------+-------+-----------------+----------------|
| Mk1 Lander Can     | landerCabinSmall    | Stock | Stock           |                |
|                    |                     |       | RPM             |                |
|                    |                     |       | DE_IVAExtension |                |
|                    |                     |       | ASET            |                |
|--------------------+---------------------+-------+-----------------+----------------|
